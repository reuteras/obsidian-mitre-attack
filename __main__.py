...
if __name__ == '__main__':
    ...
    parser.add_argument('-c', '--campaigns', help="Include campaigns in the output (will download all domains)", action='store_true')
    ...
    if args.campaigns and args.domain:
        raise ValueError("You cannot use the -c/--campaigns flag with a specific domain")
    ...
    if args.output:
        ...
        attack_file = os.path.join(output_dir, "README.md")
        with open(attack_file, 'w') as fd:
            content = "---\nalias: MITRE ATT&CK®\n---\n\n"

            content += "# MITRE ATT&CK®\n\n"
            content += "This is a collection pf pages for Obsidian of the MITRE ATT&CK® framework.\n\n"
            ...
            content += "This collection is based on the MITRE ATT&CK®" + domain + " domain version " + str(config['version']) + ".\n\n"  
